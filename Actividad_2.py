...
#1
# busqueda=texto.find("morir")
# print(busqueda)
# busqueda1=texto.find("felinos")
# print(busqueda1)
# extraer=texto[554:966]
# print(extraer)

#2
# busqueda=texto.find("El")
# busqueda1=texto.find("prisa.")
# print(f"{busqueda} {busqueda1}")
...
# equipo2=int(input("Cuantos puntos tiene el segundo equipo?: "))
# equipo3=int(input("Cuantos puntos tiene el tercer equipo?: "))
# equipo4=int(input("Cuantos puntos tiene el cuarto equipo?: "))
